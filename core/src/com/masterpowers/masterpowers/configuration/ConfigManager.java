package com.masterpowers.masterpowers.configuration;
...
public class ConfigManager {
	...
	public static void configCheck(final ConfigType type) {
		...
		if (type == ConfigType.PRESETS) {
			...
			config.addDefault("Chat.Branding.Borders.TopBorder", "&8&m                                                  ");
			config.addDefault("Chat.Branding.Borders.BottomBorder", "&8&m                                                  ");
			config.addDefault("Chat.Branding.ChatPrefix.Prefix", "\u2726 ");
			config.addDefault("Chat.Branding.ChatPrefix.Suffix", " \u00BB ");
			config.addDefault("Chat.Branding.ChatPrefix.Main", "MasterPowers &7| &bNight SMP");
			config.addDefault("Chat.Branding.ChatPrefix.Hover", "MasterPowers \u2014 the official bending plugin of Night SMP!\\nClick for more info.");
			config.addDefault("Chat.Branding.ChatPrefix.Click", "https://masterpowers.com");
			...
			config.addDefault("Commands.Version.Description", "Displays the installed version of MasterPowers.");
			...
			config.addDefault("Commands.Help.Description", "This command provides information on how to use other commands in MasterPowers.");
			...
			config.addDefault("Commands.Debug.Description", "Outputs information on the current MasterPowers installation to /plugins/MasterPowers/debug.txt");
			config.addDefault("Commands.Debug.SuccessfullyExported", "Debug File Created as debug.txt in the MasterPowers plugin folder.\nPut contents on pastie.org and create a bug report on the MasterPowers forum if you need to.");
			...
			config.addDefault("Commands.Check.Description", "Checks if MasterPowers is up to date.");
			config.addDefault("Commands.Check.NewVersionAvailable", "There's a new version of MasterPowers available!");
			...
			config.addDefault("Commands.Check.UpToDate", "You have the latest version of MasterPowers.");
